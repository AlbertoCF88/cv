...
<div class="fondo">
    ...
    <v-row>
        <v-col cols="12" md="6">
            <v-card id="div1" 
            elevation="0" color="dragon"
            dark
            width="100%" max-height="272px">
                <v-container class="pr-16">
                    <v-row>
                        <v-col cols="12" md="3" lg="2"  class="" >
                        ...
                        <v-col cols="12" md="9" lg="10" >
                            <v-list-item three-line>
                                <v-list-item-content class="d-flex justify-star">
                                    <v-list-item-title class="headline mb-1">
                                        Universo Dragon
                                    </v-list-item-title>
                                    <v-list-item-subtitle>
                                        Pagina web de ayuda al juego de mesa:<br>"Dragon ball Super, La Supervivencia del Universo"
                                    </v-list-item-subtitle>
                                 </v-list-item-content>
                            </v-list-item>
                        </v-col>
                    ...
                    <v-card-text>
                        Web realizada Con JS-Frameworks Vue CDN, librerias: animate.css, UI-framework: Bootstrap
                    </v-card-text>
                    <v-card-actions>
         ...
         <v-col cols="12" md="6">
            ...
            width="100%" max-height="272px">
                <v-container class="paddingL">
                    ...
                    <v-card-text>
                        Convertí la web Universo Dragon en web App, puedes ver la ficha de Play Store en el siguiente enlace
                    </v-card-text>
                    <v-card-actions>
                        <v-btn outlined rounded text
    ...
    <!-- <v-img  height="200"  class="construccion"
                contain
